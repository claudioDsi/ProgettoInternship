...
--
-- Host: 127.0.0.1:3306
-- Creato il: Giu 14, 2018 alle 10:43
...
CREATE TABLE IF NOT EXISTS `tutore` (
  ...
  `CodAzienda` int(11) NOT NULL,
  `EmailTutore` varchar(100) NOT NULL,
...
(1, 'admin', 'admin', 0, 'Admin', 'Admin', '16/08/1991', 'Roma', 'Roma', 'daljhsf', '165456', 'Maschio', 'admin@admin.com', 'Informatica', 0, 'Magistrale', '', ''),
